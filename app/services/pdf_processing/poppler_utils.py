...
# ------------------------------------------------------------------ #
#  Poppler path — update this if you move the Poppler folder          #
# ------------------------------------------------------------------ #
DEFAULT_POPPLER_PATH = r"C:\Users\kpecco\Downloads\Release-25.12.0-0 (1).zip\poppler-25.12.0\Library\bin"


class PDFImageConverter:
    def __init__(self, poppler_path: Optional[str] = DEFAULT_POPPLER_PATH):
        """
        Args:
            poppler_path: Path to Poppler's bin folder.
                          Defaults to DEFAULT_POPPLER_PATH above.
                          Pass None only if Poppler is on your system PATH.
        """
    ...
    def process_and_upload_guide(
        self, pdf_path: str, upload_to_s3: bool = False
    ) -> Dict[str, Any]:
